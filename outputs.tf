output "api_management_api_operation_policies_id" {
  ...
  value       = { for k, v in azurerm_api_management_api_operation_policy.api_management_api_operation_policies : k => v.id }
}
output "api_management_api_operation_policies_api_management_name" {
  ...
  value       = { for k, v in azurerm_api_management_api_operation_policy.api_management_api_operation_policies : k => v.api_management_name }
}
output "api_management_api_operation_policies_api_name" {
  ...
  value       = { for k, v in azurerm_api_management_api_operation_policy.api_management_api_operation_policies : k => v.api_name }
}
output "api_management_api_operation_policies_operation_id" {
  ...
  value       = { for k, v in azurerm_api_management_api_operation_policy.api_management_api_operation_policies : k => v.operation_id }
}
output "api_management_api_operation_policies_resource_group_name" {
  ...
  value       = { for k, v in azurerm_api_management_api_operation_policy.api_management_api_operation_policies : k => v.resource_group_name }
}
output "api_management_api_operation_policies_xml_content" {
  ...
  value       = { for k, v in azurerm_api_management_api_operation_policy.api_management_api_operation_policies : k => v.xml_content }
}
output "api_management_api_operation_policies_xml_link" {
  ...
  value       = { for k, v in azurerm_api_management_api_operation_policy.api_management_api_operation_policies : k => v.xml_link }
}
